...
const defaultClueIndex = 0
const defaultPuzzleIndex = 0
...
export default {
    namespaced: false,
    state: () => ({
        puzzleList: defaultPuzzleList,
        puzzleSize: defaultPuzzleSize,
        clueIndex: defaultClueIndex,
        puzzleIndex: defaultPuzzleIndex,
        puzzle: [],
        vowelEnabled: false
    }),
    mutations: {
    ...
    actions: {
        ...
        setBoardDefaultSettings(context) {
            context.state.puzzleSize = defaultPuzzleSize
            context.state.clueIndex = defaultClueIndex
            context.state.currentPlayer = defaultPuzzleIndex
